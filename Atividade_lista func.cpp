...
int k=0;		
    ...
    cout << "3. Pesquisar funcionario (por prontuario):" << endl;
    cout << "4. Listar funcionarios:" << endl << endl;
	...
	cout << "Funcionario retornado da pesquisa: " << find(minhaLista,prontuario)->nome <<endl;
	cout << "------------------" << endl;
